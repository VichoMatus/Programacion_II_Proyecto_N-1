...
class AplicacionConPestanas(ctk.CTk):
    ...
    def configurar_pestana2(self):
        ...
        label_nombre.pack(pady=5)
        self.entry_nombre = ctk.CTkEntry(frame_Menu)
        self.entry_nombre.pack(pady=5)

        label_cantidad = ctk.CTkLabel(frame_Menu, text="Cantidad:")
        label_cantidad.pack(pady=5)
        self.entry_cantidad = ctk.CTkEntry(frame_Menu)
        self.entry_cantidad.pack(pady=5)

        # Botón de ingreso
        self.boton_ingresar = ctk.CTkButton(frame_Menu, text="Ingresar Ingrediente")
        self.boton_ingresar.configure(command=self.ingresar_libro)
        self.boton_ingresar.pack(pady=10)
    ...
    def ingresar_libro(self):
        ...
        libro = Libros_ejemplo(nombre, cantidad)
