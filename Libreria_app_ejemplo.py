...
class AplicacionConPestanas(ctk.CTk):
    ...
    def configurar_pestana1(self):
        ...
        label_autor = ctk.CTkLabel(frame_formulario, text="Autor del Libro:")
        label_autor.pack(pady=5)
        self.entry_autor = ctk.CTkEntry(frame_formulario)
        self.entry_autor.pack(pady=5)

        label_categoria = ctk.CTkLabel(frame_formulario, text="Categoría del Libro:")
    ...
    def ingresar_libro(self):
        ...
        libro = Libros_ejemplo(nombre, autor, categoria, cantidad)
