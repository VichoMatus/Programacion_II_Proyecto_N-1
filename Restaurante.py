...
class App(ctk.CTk):
    ...
    def crear_pestaña_pedido(self):
        ...
        # Definir los menús disponibles y sus ingredientes
        self.menu_definiciones = {
            "Papas Fritas": Menu("Papas Fritas", 3.50, {"Papas": 1}),
            "Completo": Menu("Completo", 5.00, {"Pan de Completo": 1, "Vianesa": 1, "Tomate": 1}),
            "Pepsi": Menu("Pepsi", 1.50, {"Bebida": 1}),
            "Hamburguesa": Menu("Hamburguesa", 6.00, {"Pan de Hamburguesa": 1, "Churrasco de Carne": 1, "Lámina de Queso": 1}),
        }
